    ...
    def get_question_user_ai(self, dialog):
        try:
            response = self.client.messages.create(
                ...
                system="""
                1. Eres un asistente de IA simulando preguntas de un cliente de la empresa GasComunal. Basado en el contexto de la conversación previa, genera preguntas sobre:
                    - Medidores de gas
        ...
        try:
            response = self.client.messages.create(
                ...
                system=f"""
                    ...
                    2. Para saludar:
                        - Solo si la conversacion esta empezando, di que eres asistente de IA de GasComunal, saluda cortésmente y entregar un pequeño resumen de los temas que manejas.
    ...
    def get_response_image(self, question, dialog, context, image_data=None):
        try:
            ...
            response = self.client.messages.create(
                model="claude-3-5-sonnet-20240620",
                system=f"""
                    1. Eres un asistente de IA especializada en medidores de gas que analiza imágenes de medidores de gas y entrega posibles soluciones a los problemas que presentes o entrega informacion del mismo segun se solicite.
