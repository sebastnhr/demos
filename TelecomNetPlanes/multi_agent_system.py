...
class MultiAgentSystem:
    ...
    def initialize(self):
        pdf_paths = [
            "./TelecomNetPlanes/pdf/Condiciones-Comerciales-Servicio-Telefonico-Movil.pdf",
            "./TelecomNetPlanes/pdf/CondicionesContractualesTelefonicoMovil.pdf",
            "./TelecomNetPlanes/pdf/Numeracion-Especial-para-Servicios-Complementarios.pdf"
        ]
